Ellison3::Application.routes.draw do |map|
  ...
  # Sample resource route within a namespace:
    namespace :admin do
      ...
      resources :products do
				collection do
			    get :new_campaign, :edit_campaign, :new_image, :new_tab, :products_autocomplete, :reorder_tabs, :show_tabs, :product_helper, :product_helper_by_tag, :remove_tag, :add_tag, :remove_idea, :add_idea, :more_tags, :more_ideas
