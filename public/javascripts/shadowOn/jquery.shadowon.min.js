...
p&&a("body").append(i);if(n){var b=a(this);jQuery.data(b,"position",{top:k.top,left:k.left,width:g,height:h});a(b).doTimeout(j,o,function(){var t=jQuery.data(b,"position").top,u=jQuery.data(b,"position").left,v=jQuery.data(b,"position").width,w=jQuery.data(b,"position").height,q=a(b).offset();if(t!=q.top||u!=q.left||v!=a(b).outerWidth()||w!=a(b).outerHeight()){jQuery.removeData(b);a(this).shadowOff();a(this).doTimeout(j);a(this).shadowOn({imagepath:e,imageset:f,autoresize:n,resizetimer:o});return false}return true})}}})};
