...
namespace :data_import do
  ...
  task :update_allstar => :environment do
    ...
    overview = <<-HTML
      <p>Each <strong>AllStar Die</strong> exceeds the Ellison unmatched expectation of quality, including:</p><ul><li>Inexpensive, economical</li><li>Curriculum-based artwork</li><li>High-quality wood and steel rule encased in durable plastic</li><li>Reliable cuts</li><li>Ability to cut many <a href="/materials_guide" target="_blank">lightweight materials thicknesses</a></li><li>Lightweight, easy portability</li></ul><p>See the <a href="/die_size_guide">Ellison Die Size Guide</a> for more information.<br /><br /><strong>Experiencing cutting problems?</strong><br />As a general rule, steel-rule cannot be sharpened. Instead, it’s likely your Cutting Pad needs replacing. Learn how to recognize and change worn Cutting Pads by reviewing instructions for your specific machine found <a href="/maintenance" target="_blank">here</a>.</p>
    HTML
