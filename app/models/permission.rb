class Permission
  include EllisonSystem
	...
	ADMIN_MODULES = ["products", "ideas", "tags", "landing_pages", "static_pages", "shared_contents", "profiles", "users", "orders", "quotes", "coupons", "countries", "us_shipping_rates", "shipping_rates", "feedbacks", "stores"]
