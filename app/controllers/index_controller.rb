class IndexController < ApplicationController
  ...
  ssl_allowed :contact, :send_feedback, :limited_search, :machines_survey, :static_page, :reply_to_feedback, :add_comment, :newsletter, :create_subscription, :subscription, :update_subscription
  ...
  def machines_survey
    ...
    render :js => "alert('Thank you for taking this survey.');$('#machines_owned').remove();"
  end
