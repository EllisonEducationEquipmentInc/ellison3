  ...
  def create
    ...
    if @ecallite.valid?
      ...
      if code == "0"
        ...
        when "6"
          "We're sorry, the authorization code entered has already been activated. Please request a new authorization link by providing us the same email address used at the time of authorization <a class='e_link' href='http://www.craftedge.com/support/lostserial.php'>here</a>".html_safe
        when "3", "4", "5"
